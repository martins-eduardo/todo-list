...
export const inputCheckboxWrapperVariants =
  cva(`
...
export const inputCheckboxIconVariants =
  cva(
    `
...
export default function InputCheckbox({
  ...
  return (
    <label
      className={inputCheckboxWrapperVariants(
        {
          className,
        },
      )}
    >
      ...
      />
      <Icon
        className={inputCheckboxIconVariants(
          {
            size,
          },
        )}
